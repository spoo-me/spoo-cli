...
func (m Model) overviewWidth() int {
...
// saturated cut.
func (m Model) boxed(title, body string, width, height int, focused bool, hue color.Color) string {
